...
const defaultOptions = {
    ...
    rendererSettings: {
      ...
      className: "w-1/2 object-contain lg:p-20 h-1/2",
    },
  };
      ...
      {({ open }) => (
        <>
                  ...
                  <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="font-medium text-gray-500 hover:text-gray-900 hover:underline hover:italic"
                      >
                        {item.name}
                      </a>
                    ))}
          ...
          <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 ">
            <Lottie options={defaultOptions} className="w-full h-full" speed={0.85} />
          </div>
        </>
      )}
    </Popover>
